        ...
        extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient
{
    ...
    public class Offers
    {
         ...
         * @return the request
         */
        public Clone clone( java.lang.Long offerId ) throws java.io.IOException
        {
            Clone result = new Clone( offerId );
            initialize( result );
            return result;
        }
                ...
                extends ProductBillingRequest<biz.turnonline.ecosystem.billing.model.CompleteOffer>
        {
             ...
             * @since 1.13
             */
            protected Clone( java.lang.Long offerId )
            {
                super( ProductBilling.this, "POST", REST_PATH, null, biz.turnonline.ecosystem.billing.model.CompleteOffer.class );
                this.offerId = com.google.api.client.util.Preconditions.checkNotNull( offerId, "Required parameter offerId must be specified." );
            }
    ...
    public class Orders
    {
                ...
                extends ProductBillingRequest<biz.turnonline.ecosystem.billing.model.Pricing>
        {
            ...
            private static final String REST_PATH = "orders/{order_id}/delivery";
             ...
             * <p>
             * This request holds the parameters needed by the the billing server.  After setting any optional
             * parameters, call the {@link Delivery#execute()} method to invoke the remote operation. <p>
             * {@link
             * Delivery#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
             ...
             * @since 1.13
             */
            protected Delivery( java.lang.Long orderId, biz.turnonline.ecosystem.billing.model.ShippingDetails content )
            {
            ...
            @Override
            public Delivery setAlt( java.lang.String alt )
            {
                return ( Delivery ) super.setAlt( alt );
            }

            @Override
            public Delivery setFields( java.lang.String fields )
            {
                return ( Delivery ) super.setFields( fields );
            }

            @Override
            public Delivery setKey( java.lang.String key )
            {
                return ( Delivery ) super.setKey( key );
            }

            @Override
            public Delivery setOauthToken( java.lang.String oauthToken )
            {
                return ( Delivery ) super.setOauthToken( oauthToken );
            }

            @Override
            public Delivery setPrettyPrint( java.lang.Boolean prettyPrint )
            {
                return ( Delivery ) super.setPrettyPrint( prettyPrint );
            }

            @Override
            public Delivery setQuotaUser( java.lang.String quotaUser )
            {
                return ( Delivery ) super.setQuotaUser( quotaUser );
            }

            @Override
            public Delivery setUserIp( java.lang.String userIp )
            {
                return ( Delivery ) super.setUserIp( userIp );
            }
            ...
            public Delivery setOrderId( java.lang.Long orderId )
            {
                this.orderId = orderId;
                return this;
            }
            ...
            @Override
            public Delivery set( String parameterName, Object value )
            {
    ...
    public class Products
    {
                ...
                extends ProductBillingRequest<biz.turnonline.ecosystem.billing.model.Product>
        {
            ...
            public Insert setPicsFrom( java.util.List<java.lang.String> picsFrom )
            {
