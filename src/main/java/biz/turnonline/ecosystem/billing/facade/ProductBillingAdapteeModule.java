...
import biz.turnonline.ecosystem.billing.facade.adaptee.OrderShippingDetailsUpdateAdaptee;
        ...
        extends AbstractModule
{
    ...
    protected void configure()
    {
        ...
        bind( new TypeLiteral<UpdateExecutorAdaptee<ShippingDetails>>()
        {
        } ).to( OrderShippingDetailsUpdateAdaptee.class );
        ...
        // Expense
        bind( new TypeLiteral<ListExecutorAdaptee<Expense>>()
        {
