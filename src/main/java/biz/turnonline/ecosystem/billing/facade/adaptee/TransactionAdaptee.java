...
/**
 * * The {@link Transaction} adaptee implementation.
 *
 * @author <a href="mailto:medvegy@turnonline.biz">Aurel Medvegy</a>
 */
@Singleton
public class TransactionAdaptee
        extends AbstractInsertExecutorAdaptee<ProductBilling, Transaction>
        implements InsertExecutorAdaptee<Transaction>
{
    @Inject
    public TransactionAdaptee( Provider<ProductBilling> client )
    {
        super( client );
    }

    @Override
    public Object prepareInsert( @Nonnull Transaction resource,
                                 @Nullable Identifier parentKey,
                                 @Nullable MediaProvider provider ) throws IOException
    {
        return client().transactions().insert( resource );
    }
}
