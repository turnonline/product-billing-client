...
/**
 * The {@link OfferListItem} LIST adaptee implementation.
 *
 * @author <a href="mailto:medvegy@turnonline.biz">Aurel Medvegy</a>
 */
@Singleton
public class OfferListAdaptee
        extends AbstractGoogleClientAdaptee<ProductBilling>
        implements ListExecutorAdaptee<OfferListItem>
{
    @Inject
    public OfferListAdaptee( Provider<ProductBilling> client )
    {
        super( client );
    }
    ...
    {
        return client().offers().list();
    }

    @Override
    public List<OfferListItem> executeList( @Nonnull Object request,
    ...
    {
        ProductBilling.Offers.List list = ( ProductBilling.Offers.List ) request;
