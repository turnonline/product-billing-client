...
/**
 * The {@link CompleteOffer} GET adaptee implementation.
 *
 * @author <a href="mailto:medvegy@turnonline.biz">Aurel Medvegy</a>
 */
public class OfferGetAdaptee
        extends AbstractGetExecutorAdaptee<ProductBilling, CompleteOffer>
{
    @Inject
    public OfferGetAdaptee( Provider<ProductBilling> client )
    {
        super( client );
    }
    ...
    {
        return client().offers().get( identifier.getLong() );
    }
}
